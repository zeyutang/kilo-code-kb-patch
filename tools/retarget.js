...
// and the core chat-scroll blocks apply only while Kilo's textarea rule, its
// chat templates and its scroll threshold still look the way they assume), so
// there is never anything to paste, only "still readable" or ERROR.
//
